...
public class ResizeHelper {
    ...
    public static void addListenerDeeplyToView(BorderPane pane, ResizeListener resizeListener) {
        pane.addEventHandler(MouseEvent.MOUSE_MOVED, resizeListener);
        pane.addEventHandler(MouseEvent.MOUSE_PRESSED, resizeListener);
        pane.addEventHandler(MouseEvent.MOUSE_DRAGGED, resizeListener);
        pane.addEventHandler(MouseEvent.MOUSE_EXITED, resizeListener);
        pane.addEventHandler(MouseEvent.MOUSE_EXITED_TARGET, resizeListener);
